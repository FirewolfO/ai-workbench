...
async function load() {
  loading.value = true
  try { result.value = await workbenchApi.news(search.value, source.value, favoriteOnly.value) }
...
<template>
  <section class="page content-page">
    ...
    <div class="sync-line"><span>最近同步：{{ formatSync(result.lastSuccessAt) }}</span><el-tooltip v-if="result.lastError" :content="result.lastError"><el-tag type="warning" effect="plain">部分来源异常</el-tag></el-tooltip></div>
